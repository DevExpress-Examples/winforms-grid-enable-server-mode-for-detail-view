...
'			Me.myGridView1.MasterRowGetRelationName += New DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationNameEventHandler(Me.myGridView1_MasterRowGetRelationName);
'			Me.myGridView1.MasterRowGetChildList += New DevExpress.XtraGrid.Views.Grid.MasterRowGetChildListEventHandler(Me.myGridView1_MasterRowGetChildList);
'			Me.myGridView1.MasterRowEmpty += New DevExpress.XtraGrid.Views.Grid.MasterRowEmptyEventHandler(Me.myGridView1_MasterRowEmpty);
'			Me.myGridView1.MasterRowGetRelationCount += New DevExpress.XtraGrid.Views.Grid.MasterRowGetRelationCountEventHandler(Me.myGridView1_MasterRowGetRelationCount);
			' 
			' colEmployeeID
			' 
		...
		Private WithEvents myGridView1 As DXSample.MyGridView
